...
__ℳ_________🦅________BOYKA_𝕋𝕖𝔸𝕞_🦅_________ᔕ ____
...
os.execute('wget https://raw.githubusercontent.com/BOYKABOT1/BOYKABOT/master/BOYKA.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BOYKABOT1/Files_BOYKA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BOYKABOT1/Files_BOYKA/master/File_Bot/"..file)
if res == 200 then
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel BOYKA 🦅](https://t.me/iraqqpqp)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كاولي').."مغادره" or text == 'مغادره' or text == 'مغادرة' then  
